...
insert into public.member (id, full_name, student_id, department, position, work_status) values
  ...
  ('M006', 'พ้นสภาพ', '6500006', 'ฝ่ายวิชาการ', 'สมาชิก', 'พ้นสภาพ/ลาออก'),
...
insert into public.letter (id, department, task_id, subject, status) values
  ...
  ('L002', 'ฝ่ายสถานที่', 'T004', 'หนังสือ 2', 'ตอบรับแล้ว');

insert into public.registration (id, full_name, status, checkin_status) values
  ('R001', 'ก', 'ลงทะเบียนสำเร็จ', 'เช็คอินแล้ว'), ('R002', 'ข', 'ยืนยันสิทธิ์', 'ยังไม่เช็คอิน'),
  ('R003', 'ค', 'ลงทะเบียนสำเร็จ', 'เช็คอินแล้ว');
